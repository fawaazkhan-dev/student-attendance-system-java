...
public class LoginLecturer extends JFrame {
	...
	private Image img_logo = new ImageIcon(LoginLecturer.class.getResource("/high-school.png")).getImage().getScaledInstance(90,90,Image.SCALE_SMOOTH);
	private Image img_username = new ImageIcon(LoginLecturer.class.getResource("/businessman.png")).getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH);
	private Image img_password = new ImageIcon(LoginLecturer.class.getResource("/padlock.png")).getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH);
	private Image img_login = new ImageIcon(LoginLecturer.class.getResource("/key.png")).getImage().getScaledInstance(40,40,Image.SCALE_SMOOTH);
	...
	public LoginLecturer() {
		...
		panel.setBounds(180, 137, 250, 40);
		...
		panel_1.setBounds(180, 187, 250, 40);
		...
		txtPassword.setEchoChar((char)0);
		txtPassword.setText("Password");
		txtPassword.setBounds(10, 11, 170, 18);
		...
		pnlBtnLogin.setBounds(180, 255, 250, 50);
		...
		btnNewLabel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					PreparedStatement stm = con.prepareStatement("select * from lecturer where username =? and password=?");
					...
					if (rs.next()) {
						...
						//dispose();
						LecturerDashboard f = new LecturerDashboard();
						f.show();
						dispose();
		...
		btnNewLabel.setBounds(98, 11, 142, 28);
		pnlBtnLogin.add(btnNewLabel);
		
		JLabel lblIconLogin = new JLabel("");
		lblIconLogin.setBounds(25, 0, 50, 50);
		...
		*/
		...
		lblIconLogo.setBounds(180, -11, 250, 123);
		...
		txtAdmin.setText("LECTURER");
		txtAdmin.setBounds(263, 97, 86, 20);
		...
		pnlBtnCancel.setBounds(180, 315, 250, 50);
		...
		btnCancel.setBounds(98, 11, 142, 28);
		pnlBtnCancel.add(btnCancel);
		
		JLabel lblIconCancel = new JLabel("");
		lblIconCancel.setBounds(27, 0, 50, 50);
